...
public class Controlador implements ActionListener {
    ...
    private EnumMap<TipoContacto, Integer> tiposContacto = new EnumMap<TipoContacto, Integer>(TipoContacto.class);
    ...
    /*
     * Busca los paises, provincias, localidades y tipos de contactos de la base 
     * de datos y los guarda en listas
     */
	...
	/*
	 * SimpleDateFormat format = new SimpleDateFormat("yyyyMMdd"); Date parsed =
	 * format.parse(nacimiento); java.sql.Date date = new
	...
	if (!ventanaPersonaEditar.validarRequeridos()) {
	    ...
	    try {
		personaEditada = new PersonaDTO(idPersona, nombre, tel, email, parseNacimiento(nacimiento), idDomicilio,
			idTipoContacto);
    ...
    public void addPaisesItems(List<String> list) {
	for (String string : list) {
