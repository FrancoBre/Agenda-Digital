...
public class PersonaTest {
	...
	personas.add(new PersonaDTO(1, "Franco", "1135760584", "franco@gmail.com", null, 1, 1));
	...
	domicilios.add(new DomicilioDTO(1, "Plus Ultra", "6271", "1", "1", 1));
	
	Agenda.wire(personas, paises, provincias, localidades, tiposContacto, domicilios);
	...
	assertEquals(personas.get(0).getDomicilio(), domicilios.get(0));
    }
